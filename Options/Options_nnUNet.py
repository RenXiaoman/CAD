...
class Options_UNet_AHCDU(BaseOptions):
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--resume', type=str, default='True', help='True: resume from task model_latest.pth; False/None: train from scratch; otherwise path to checkpoint')
        parser.set_defaults(lr=1e-4, gpu_ids='0', epoch=400)
        self.isTrain = True
        return parser
    
class Options_UNet_PICAI(BaseOptions):
    """This class includes training options.
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--task_name', type=str, default='SegTumor_nnUNet_PI-CAI', help='the current task name')
...
class Options_UNet_FullPICAI(BaseOptions):
    """Training options for nnUNet on the full PI-CAI split (Dataset141)."""
    ...
    def initialize(self, parser):
        ...
        parser.add_argument(
            '--task_name',
            type=str,
            default='SegGland_nnUNet_FullPICAI',
