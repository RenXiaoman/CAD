...
df_modified = "/media/lib/D/renxiaoman/PyCharmProjects/MoSID/dataset/ChengdaOnlyCSPca/二分类模型内部测试_modified.xlsx"
# 用法示例
# rename_patient_dirs("/media/lib/D/renxiaoman/PyCharmProjects/MoSID/dataset/ChengdaOnlyCSPca/val")

# # 使用示例
# rename_patient_names_with_pandas("/media/lib/D/renxiaoman/PyCharmProjects/MoSID/dataset/ChengdaOnlyCSPca/二分类模型内部测试.xlsx")


df = pd.read_excel(df_modified)
verify_dirs_against_excel(root_dir, df)