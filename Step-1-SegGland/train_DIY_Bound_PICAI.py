...
# Local imports
from Options.Options_DIY import Options_DIY_Bound_PICAI
...
def main():
    # Parse options
    opt_parser = Options_DIY_Bound_PICAI()
    ...
    train_dataset = Boundary_DataSet(Path(opt.datapath),
                                     'imagesTr', 
                                     'labelsTr', 
                                     enable_augmentation=True,
                                     boundary_radius=opt.boundary_radius)
    val_dataset = Boundary_DataSet(Path(opt.datapath), 
                                   'imagesTs', 
                                   'labelsTs',
