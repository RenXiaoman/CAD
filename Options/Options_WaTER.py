...
class Options_WaTER_AHCDU(BaseOptions):
    """Training options for WaTER on AHCDU."""
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--task_name', type=str, default='SegGland_WaTER_AHCDU', help='the current task name')
        ...
        parser.set_defaults(lr=1e-4, gpu_ids='2', epoch=350)
        self.isTrain = True
        return parser


class Options_WaTER_PICAI(BaseOptions):
    """Training options for WaTER on PICAI."""
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--task_name', type=str, default='SegGland_WaTER_PICAI_NoAug', help='the current task name')

        parser.add_argument('--dice_weight', type=float, default=0.5, help='weight for Dice loss')
        parser.add_argument('--focal_weight', type=float, default=0.5, help='weight for Focal loss')
        parser.add_argument('--batch_size', type=int, default=3, help='input train batch size')
        parser.add_argument('--resume', type=str, default='False', help='False, True, or checkpoint path')
        parser.set_defaults(lr=1e-4, gpu_ids='3', epoch=350)
        self.isTrain = True
        return parser


class Options_WaTER_FullPICAI(BaseOptions):
    """Training options for WaTER on the full PI-CAI split (Dataset141)."""
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--task_name', type=str, default='SegGland_WaTER_FullPICAI', help='the current task name')
        parser.add_argument('--dice_weight', type=float, default=0.5, help='weight for Dice loss')
        parser.add_argument('--focal_weight', type=float, default=0.5, help='weight for Focal loss')
        parser.add_argument('--batch_size', type=int, default=3, help='input train batch size')
        parser.add_argument('--resume', type=str, default='False', help='False, True, or checkpoint path')
        parser.set_defaults(lr=1e-4, gpu_ids='3', epoch=12, model_save_fre=2)
        self.isTrain = True
        return parser
